    ...
    <div class="menuArea">
      <q-tabs align="center" id="mealCartTabs" v-model="activeTab" active-color="pink-6" mobile-arrows>
        ...
        <div class="tabContent">
          ...
          <q-tab name="daohua" @click="scrollTo('daohua')">
            <div class="row justify-center items-center">
              <img loading="lazy" class="deliciousTabImg" src="/delicious/2-pic-5.svg" />
              <p>花豆囍事</p>
            </div>
          </q-tab>
  ...
  const handleScroll = () => {
    if (!isScrolling) {
      ...
      scrollTimeout = setTimeout(() => {
        const anchorElements = ['#bandong', '#box', '#solo', '#riceBox', '#daohua'].map(id => document.querySelector(id))
