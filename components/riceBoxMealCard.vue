...
const slides = ref([
  {
    card: {
      ...
      text: {
        ...
        text2: '滷蛋+杏鮑菇+香滷豆干 ',
        smallNote: '*加贈豆花不指定口味，本檔活動為預訂贈送豆花，故無飲品加購優惠'
        // note: '湯飲品擇1'
      },
      price: 'NT$100'
    },
    dialog: {
      ...
      listItems: [
        ...
        //     { text: '季節甜品', name: '季節甜品', product_option_value_id: 2239 },
      ...
      listItems: [
        {
          ...
          // span: '6擇1',
          items: [{ text: '香炸雞翅油飯盒', name: '極品油飯', image: '/delicious/2-pic-18.png', product_option_value_id: 2228 }]
        }
        // {
        //   title: '加購湯飲品',
        //   id: 2,
...

  {
    ...
    dialog: {
      ...
      listItems: [
        ...
        //     { text: '季節甜品', name: '季節甜品', product_option_value_id: 1760 },
  ...
  },
  {
    ...
    dialog: {
      ...
      listItems: [
        ...
        //     { text: '季節甜品', name: '季節甜品', product_option_value_id: 1753 },
